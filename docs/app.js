...
var toolData={
  ...
  'hsv-extractor':{icon:'🎨',iconBg:'var(--purple-bg)',name:'HSV 色相精准提取器',ver:'v1.0',status:'online',subtitle:'色相吸取 · 灰度保留 · 边缘羽化 · 三视窗预览',desc:'点击原图吸取目标色，以 HSV 色相为判据精准提取区域。通道图保留明度灰度信息，边缘 Smoothstep 羽化无锯齿。支持多色相叠加和独立通道导出。',tags:['在线工具','HSV色相','灰度保留','边缘羽化','精准提取'],env:'🌐 浏览器在线',platform:'Win / Mac / Linux',install:'无需安装',date:'2026-04-01',url:'knowledge-base/hsv-mask-extractor.html'},
