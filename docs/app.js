...
var toolData={
  ...
  'image-skew-corrector-online':{icon:'📐',iconBg:'var(--orange-bg)',name:'图片倾斜矫正工具 (在线版)',ver:'v1.0',status:'online',subtitle:'霍夫变换 + 最小外接矩形 + 投影方差法 · 批量处理',desc:'纯浏览器运行的图片倾斜矫正工具。多算法融合检测倾斜角度，自动矫正到垂直，支持批量处理、对比预览、打包下载。',tags:['在线工具','倾斜矫正','批量处理','多算法融合'],env:'🌐 浏览器在线',platform:'Win / Mac / Linux',install:'无需安装',date:'2026-04-02',url:'knowledge-base/image-skew-corrector-online.html'},
  'game-resource-toolkit-online':{icon:'🛠️',iconBg:'var(--cyan-bg)',name:'游戏资源工具集 (在线版)',ver:'v1.0',status:'online',subtitle:'资源检测 + 图片续排 + 版本对比 + 问题修复',desc:'纯浏览器运行的All-in-one资源管理工具。支持资源规范检测、批量重命名续排、版本差异对比、命名/尺寸/格式批量修复。',tags:['在线工具','资源检测','续排','版本对比','修复'],env:'🌐 浏览器在线',platform:'Win / Mac / Linux',install:'无需安装',date:'2026-04-02',url:'knowledge-base/game-resource-toolkit-online.html'},
