...
> **[P0]** "竞品上了类似角色，我们得差异化..." —— 需求冻结后最怕听到的一句话

**📊 5-Why 分析链**：

- **Why-1**：为什么策划需求冻结延迟 7 天？→ 策划内部对角色设定方案有分歧
- **Why-2**：为什么有分歧？→ 制作人中途加入新的设计方向
- **Why-3**：为什么制作人中途改方向？→ 竞品上线了类似角色，需要差异化
- **Why-4**：为什么竞品分析没有提前做？→ 预研期未做系统性竞品分析
- **Why-5**：为什么没做竞品分析？→ 缺乏标准化的预研流程 Checklist

> 🎯 **根因**：预研流程缺少竞品分析环节
>
> 📝 **措施**：在预研 Checklist 中增加竞品分析必选项

#### 🤯 问题 2：外包质量差

> **[高频]** "按照你们给的参考做的啊" —— 外包 CP 的经典回复

**📊 5-Why 分析链**：

- **Why-1**：为什么外包首批质量差？→ CP 对项目风格理解有偏差
- **Why-2**：为什么理解偏差？→ 风格指南文档不够详细
- **Why-3**：为什么不够详细？→ 赶进度没时间做详细的风格文档
- **Why-4**：为什么没时间？→ 风格文档未列入正式排期
- **Why-5**：为什么没排期？→ 团队认为口头沟通够了

> 🎯 **根因**：外包启动前缺少标准化的风格指南交付物
>
> 📝 **措施**：外包启动前必须提供《风格指南》文档，并列入排期
