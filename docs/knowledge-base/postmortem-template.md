...
> 2. [🎯 版本目标回顾](#-2-版本目标回顾)
> 3. [📅 时间线梳理](#-3-时间线梳理)
> 4. [✨ 做得好的 (What Went Well)](#-4-做得好的-what-went-well)
> 5. [🚨 需要改进的 (What Went Wrong)](#-5-需要改进的-what-went-wrong)
> 6. [✅ Action Items](#-6-action-items)
> 7. [📊 数据统计](#-7-数据统计)
> 8. [💎 经验沉淀](#-8-经验沉淀)
> 9. [📅 附录：复盘会议 Agenda](#-附录复盘会议-agenda)
...
>
> 🎬 **典型场景还原**
> - **策划**："角色设定方案内部还有分歧，再给我们几天……"
> - **制作人**："竞品上线了，加入一个新设计方向。"
> - **APM**："需求冻结延迟 7 天，角色排期整体后移，Alpha 延期 3 天。"
>
> 🔍 **问题根因拆解**
> - 策划内部对角色设定方案有分歧
> - 制作人中途因竞品上线加入新设计方向
...
>
> 💡 **APM 破局思路**
> 1. 在预研 Checklist 中增加**竞品分析必选项**
> 2. 预研期输出《竞品分析报告》作为方案锁定的前置条件
> 3. 需求冻结前必须完成制作人签字确认
...
> 🎬 **典型场景还原**
> - **外包 CP**："按你们给的参考图做的呀？"
> - **主美**："风格偏差大、面数超标，4/5 个打回。"
> - **APM**："只给了参考图和口头说明，没有详细风格指南……"
>
> 🔍 **问题根因拆解**
...
>
> 💡 **APM 破局思路**
> 1. 外包启动前必须提供《风格指南》文档并列入排期
> 2. 首件样品机制 — CP 先做 1 个标杆件，通过后再批量
> 3. 合同增加"首批样品不通过可解约"条款
