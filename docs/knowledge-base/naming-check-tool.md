...
║ 扫描文件: 1,284 个                               ║
║ 违规文件: 47 个 (3.7%)                           ║
║ 🔴 Error: 12  🟡 Warning: 28  🟢 Info: 7        ║
╠══════════════════════════════════════════════════╣

🔴 Error 列表:
─────────────────────────────────────────────
文件: /Character/Hero/新角色_最终版.fbx
规则: N001 - 包含中文字符
建议: SK_Hero_NewChar.fbx

文件: /Character/Hero/Luna (copy).fbx
规则: N002 - 包含空格和括号
建议: SK_Hero_Luna.fbx
...
╚══════════════════════════════════════════════════╝
