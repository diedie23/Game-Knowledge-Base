...
> **📑 目录导航**
>
> 1. [美术资产根目录结构设计](#1-美术资产根目录结构设计)
> 2. [每个工种子目录规范](#2-每个工种子目录规范)
> 3. [文件命名规约](#3-文件命名规约)
> 4. [SVN vs Perforce 分支策略](#4-svn-vs-perforce-分支策略)
> 5. [权限模型](#5-权限模型)
> 6. [常见踩坑案例](#6-常见踩坑案例)
> 7. [Commit Message 规范](#7-commit-message-规范)
...
> 🚨 **案例 3：引用路径断裂——本地 rename 导致引擎材质全部失效**
>
> 🎬 **典型场景还原**
...
> 🚨 **案例 4：Temp 目录膨胀——仓库半年从 20GB 膨胀到 120GB**
>
> 🎬 **典型场景还原**
