...
**🔄 [变更签核 SOP](#4️⃣-变更签核-sop)**

**🚨 [典型问题](#典型问题)**

**📌 [Do / Don't 示例](#dodont-示例)**

**📎 [附录：年度预算规划](#-附录年度外包预算规划模板)**
</div>
...
> 🚨 **问题现象**
> CP 报价 ¥45,000/角色，APM 无基线判断合理性，直接签约后发现市场均价仅 ¥30,000。
...
> - 报价审批前必须附上**基线对比表**
> - 单价超出基线 20% 的需制作人特批
> - 建立 CP 报价历史库，作为后续谈判依据

---

### 🚨 问题二：结算扯皮——交付后双方对质量有争议

> 🚨 **问题现象**
> CP 交付资产后，甲方认为质量不达标，CP 认为已满足合同要求，双方扯皮 3 周未结算。
...
> 🛡️ **预防措施**
> - 合同附件增加**验收 Checklist**（含截图对比）
> - 首件样品机制 → 先做 1 个标杆件通过后再批量
> - 每次验收**截图 + 书面记录**，避免口说无凭
