...
> 🏷️ **[P0] [里程碑必做]** 适用阶段：测试期 | ⚡ 优先级：高 | 👤 负责人：周八
>
...
>    - [动画质量](#-23-动画质量)
>    - [特效质量](#-24-特效质量)
> 3. [🏔️ 场景走查清单](#️-3-场景走查清单)
>    - [视觉质量](#-31-视觉质量)
>    - [功能性检查](#️-32-功能性检查)
>    - [性能检查](#-33-性能检查)
> 4. [🖥️ UI 走查清单](#️-4-ui-走查清单)
>    - [视觉检查](#-41-视觉检查)
>    - [适配检查](#-42-适配检查)
> 5. [📱 设备适配验证](#-5-设备适配验证)
> 6. [📸 截图归档规范](#-6-截图归档规范)
> 7. [📎 附录：走查效率优化建议](#-附录走查效率优化建议)
...
>
> 🎬 **典型场景还原**
> - **QA**："iPhone 15 Pro 上主界面左上角的返回按钮被刘海遮住了，点不到。"
> - **程序**："我们是硬编码的 `top: 44px` 偏移量来避让刘海区……"
> - **APM**："但不同厂商安全区标准不一样，三星的药丸屏和苹果的刘海屏偏移量不同。"
>
> 🔍 **问题根因拆解**
> - 硬编码偏移值适配刘海屏，没有使用系统 **SafeArea API**
> - 不同厂商（Apple / Samsung / 小米）的安全区域标准不同，固定值无法通用
> - 走查时只测了 iPhone，没有覆盖全部目标机型
>
> 💡 **APM 破局思路**
> 1. 要求程序统一使用 **SafeArea API** 适配，不硬编码偏移值
> 2. 在适配检查矩阵中覆盖所有目标机型，每次走查逐一验证
> 3. 建立**设备适配回归清单**，每个涉及 UI 的版本必须逐机型过一遍
...
> 📌 **场景说明：截图命名**
>
> 走查过程中截取的截图需要按统一命名规则归档，方便后续 Bug 追踪与复查。
>
> ✅ **Do（正确示范）**
...
>
> ❌ **Don't（错误示范）**
> - `截图1.png` / `新建文件夹/screenshot.jpg` / `IMG_20260407.png`
> - ❌ 无版本号 → 无法关联到具体版本
> - ❌ 无设备信息 → 无法复现适配问题
> - ❌ 无模块标识 → 无法归类到对应走查模块
