...
> **📑 目录导航**
>
> 1. [📋 按工种基准人天表](#1️⃣-按工种分类的基准人天表)
>    - [角色原画](#-11-角色原画) / [角色 3D 建模](#-12-角色-3d-建模)
>    - [场景建模](#️-13-场景建模) / [UI 设计](#️-14-ui-设计)
>    - [特效](#-15-特效) / [动画](#-16-动画)
> 2. [📊 复杂度评估标准](#2️⃣-复杂度评估标准)
> 3. [⚠️ 风险系数加成](#3️⃣-风险系数加成)
> 4. [💰 报价公式模板](#4️⃣-报价公式模板)
> 5. [🔍 评审与校准机制](#5️⃣-评审与校准机制)
> 6. [📋 实际案例：角色全流程人天拆解](#6️⃣-实际案例角色全流程人天拆解)
> 7. [🚨 典型问题](#典型问题)
> 8. [📌 Do / Don't 示例](#dodont-示例)
> 9. [📎 附录：快速估价卡片](#-附录快速估价参考卡片)
...
> 🚨 **案例 1：评估偏差导致外包预算严重超支**
>
> 🔴 **[高频]** 首次合作 CP、复杂角色评估时频发
>
> 🎬 **典型场景还原**
> - **APM**："这批 5 个角色建模，我评的 B 级复杂度，预估 60 人天。"
> - **主美**（收到成品后）："这些角色都有可拆卸武器和复杂配饰，明显是 A 级啊。"
> - **财务**："实际耗时 92 天，偏差率 53%，预算超支 ¥48,000。"
> - **APM**："当时凭感觉定的级……没用打分表。"
>
> 🔍 **问题根因拆解**
...
> 4. 所有评估必须使用**五维度打分表**，禁止"拍脑袋"定级
> 5. 每季度进行**评估准确率复盘**，偏差 > 20% 的工种重新校准
> 6. 首次合作 CP 强制叠加 ×1.2 风险系数
