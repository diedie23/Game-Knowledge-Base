...
> 2. [📂 引擎目录结构](#-2-引擎目录结构)
>    - [UE 标准目录](#-21-ue-标准目录)
>    - [Unity 标准目录](#-22-unity-标准目录)
> 3. [✅ 引擎导入 Checklist](#-3-引擎导入-checklist)
>    - [模型导入 (FBX)](#-31-模型导入-fbx)
>    - [贴图导入](#-32-贴图导入)
>    - [动画导入](#-33-动画导入)
> 4. [🔄 资产交接 SOP](#-4-资产交接-sop)
>    - [交接流程](#-41-交接流程)
>    - [交接单模板](#-42-交接单模板)
>    - [常见交接问题速查](#-43-常见交接问题速查)
> 5. [🤝 跨部门交接边界](#-5-跨部门交接边界)
> 6. [🚨 典型问题](#典型问题)
> 7. [📌 Do / Don't 示例](#dodont-示例)
> 8. [📎 附录：快速参考卡](#-附录快速参考卡)
...
> 🚨 **案例 1：中文/特殊字符文件名导致引擎导入失败**
>
> 🔴 **[高频]** 新人入职、外包交付阶段频发
>
> 🎬 **典型场景还原**
> - **美术新人**："我在 Maya 里存的文件名叫 `新角色_最终版.fbx`，本地打开都正常啊？"
> - **TA**："但导入 UE 后路径解析失败了，引擎里所有引用全断了。"
> - **APM**："而且空格和括号也有问题，命令行工具 `fbx2gltf` 参数解析直接出错。"
>
> 🔍 **问题根因拆解**
...
> 4. 新人入职首日必读《引擎导入与命名规范》
> 5. 每月抽查一次版本库，输出命名合规率报告
> 6. 将命名检查集成到**自动化提交流水线**中

---

> 🚨 **案例 2：FBX 导入后模型破面/法线翻转**
>
> 🔴 **[中频]** 角色/场景资产交接阶段
>
> 🎬 **典型场景还原**
> - **TA**："Luna 的模型导入 UE 后脸部有好几块黑面，但 Maya 里看着完全正常。"
> - **美术**："我确认过了，Maya 里是好的啊，是不是引擎的问题？"
> - **TA**："Maya 默认开了双面显示，你翻转的法线在 Maya 里看不出来，引擎里就暴露了。另外模型还有退化三角面。"
>
> 🔍 **问题根因拆解**
...
> 4. 在**自检 Checklist** 中增加"法线方向检查"为必选项
> 5. 建立 TA 导入后**引擎端截图对比**环节，确保 DCC 与引擎一致
