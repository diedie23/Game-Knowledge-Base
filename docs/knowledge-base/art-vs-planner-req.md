...
1. **美术与策划分歧** → APM 主持协商，给出数据支撑
2. **无法达成一致** → 升级到主美 + 制作人层面决策
3. **技术不可行** → TA 出具技术评估报告
4. **工期分歧** → APM 出具历史数据对比
...
| 项目 | 说明 |
|------|------|
| **表现** | "做一个好看的角色"、"参考某游戏的感觉" |
| **根因** | 策划缺乏美术语言，参考图不足 |
| **APM 解法** | 主动要求补充参考图，组织 15min 面对面沟通，产出一份美术理解确认书 |
| **预防** | 提供需求单填写指南培训 |
...
| 项目 | 说明 |
|------|------|
| **表现** | 原画做到一半改设定，建模快完成改造型 |
| **根因** | 策划设计未收敛就下需求 / 上级反复审 |
| **APM 解法** | 建立变更流程，量化变更成本，定期汇报变更次数和代价 |
| **话术** | "这次变更预计影响 **3d** 工期和 **¥5k** 外包成本，需要您和制作人确认" |

### 5.3 优先级争议

| 项目 | 说明 |
|------|------|
| **表现** | 所有需求都标 P0，策划 A 说自己更急 |
| **根因** | 缺乏统一的优先级仲裁机制 |
| **APM 解法** | 建立优先级矩阵（紧急×重要），每周制作人会上统一排序 |
| **原则** | P0 全项目不超过 **3 个**，由制作人/总监拍板 |
