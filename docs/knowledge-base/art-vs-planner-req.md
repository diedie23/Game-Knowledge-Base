...
>    - [变更冻结期规则](#43-变更冻结期规则)
> 5. [常见冲突场景与解法](#5-常见冲突场景与解法)
> 6. [附录：跨部门协作日历](#附录跨部门协作日历)
...
> 📌 **场景说明**：参考图提交规范
>
> ✅ **Do (正确示范)**：提交 3 张参考图，分别标注"图1-造型参考""图2-配色参考""图3-材质参考"，附带反面参考说明"不要暖色系"。
>
> ❌ **Don't (错误示范)**：甩一句"参考某游戏的感觉"，不附任何图片；或贴 10 张风格完全不同的图让美术"自行理解"。
...
>
> 🔍 **问题根因拆解**
> - **表面**：原画做到一半改设定，建模快完成改造型
> - **中层**：策划设计未收敛就下需求 / 上级反复审核
> - **深层**：缺乏变更成本可视化机制
>
> 💡 **APM 破局思路 / 解决方案**
...
> 3. 定期汇报变更次数和代价，形成压力
> 4. 建立 **变更成本可视化看板**，让决策者在知道代价的前提下做决定
