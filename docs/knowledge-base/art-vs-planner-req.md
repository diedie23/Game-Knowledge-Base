...
|:---:|:---:|:---:|
| 🔸 **表面** | 需求描述模糊、参考图不足 | 策划 |
| 🔶 **中层** | 策划缺乏美术语言，不知道怎么描述 | 策划 + APM |
| 🔴 **深层** | 缺少需求单填写指南和培训 | 流程缺陷 |

#### 💡 破局思路

- ① **APM 主动出击**：主动要求补充参考图
- ② **面对面沟通**：组织 **15min 面对面沟通**，产出一份美术理解确认书
- ③ **预防培训**：提供 **需求单填写指南培训**
...
> **[P0]** "原画做到一半改设定，建模快完成改造型" —— 美术最痛恨的需求翻烧饼

#### 🔍 问题根因拆解

| 🏷️ 层级 | 🔍 原因 | 👤 责任方 |
|:---:|:---:|:---:|
| 🔸 **表面** | 原画做到一半改设定，建模快完成改造型 | 策划 |
| 🔶 **中层** | 策划设计未收敛就下需求 / 上级反复审 | 策划 + 管理层 |
| 🔴 **深层** | 缺乏变更成本可视化机制 | 流程缺陷 |

#### 💡 破局思路

- ① **建立变更流程**，所有变更走 TAPD 工单
- ② **量化变更成本**，每次变更明确标注影响人天和费用
- ③ **定期汇报**变更次数和代价，形成压力
